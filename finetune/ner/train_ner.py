...
# We use and adapt this NEWS script, originally from the MasakhaNER repository (https://github.com/masakhane-io/masakhane-ner)
...
from modeling_ltgbert import LtgBertForTokenClassification, LtgBertForMaskedLM
...
MODEL_CLASSES = {
    ...
    "ltgbert": (LtgBertConfig, BertForTokenClassification, PreTrainedTokenizerFast)
}
...
def train(args, train_dataset, model, tokenizer, labels, pad_token_label_id):
    ...
    for _ in train_iterator:
        ...
        if args.n_gpu ==1 and global_step > 500:
