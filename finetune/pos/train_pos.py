# We use and adapt this POS traing script, originally from the MasakhaPOS repository (https://github.com/masakhane-io/masakhane-pos)
...
from transformers import AutoModelForSequenceClassification, AutoModelForTokenClassification, \
    AutoConfig, AutoTokenizer, AutoModel, PreTrainedTokenizerFast
...
import random
from modeling_ltgbert import LtgBertForTokenClassification
...
MODEL_CLASSES = {
    ...
    "ltgbert": (LtgBertConfig, LtgBertForTokenClassification, PreTrainedTokenizerFast)
}
        ...
        for step, batch in enumerate(epoch_iterator):
            ...
            if args.model_type != "distilbert":
                inputs["token_type_ids"] = (
                    batch[2] if args.model_type in ["ltgbert","bert", "xlnet"] else None
...
def main():
    ...
    config_class, model_class, tokenizer_class = LtgBertConfig, LtgBertForTokenClassification, PreTrainedTokenizerFast #MODEL_CLASSES[args.model_type]

    script_dir = os.path.dirname(os.path.abspath(__file__))
    pretrained_model_path = os.path.join(script_dir, '5e4196epochwithlong')
